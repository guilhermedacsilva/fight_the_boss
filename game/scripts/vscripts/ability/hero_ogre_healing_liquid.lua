hero_ogre_healing_liquid = class ({})

LinkLuaModifier("modifier_hero_ogre_healing_liquid", "ability/modifier_hero_ogre_healing_liquid.lua", LUA_MODIFIER_MOTION_NONE )

function hero_ogre_healing_liquid:OnSpellStart()
	...
	for _,unit in pairs(units) do
		unit:AddNewModifier( caster, self, "modifier_hero_ogre_healing_liquid", { duration = buff_duration } )
	end
